System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UiMain", UiMain = (_dec = ccclass('UiMain'), _dec2 = property(Node), _dec(_class = (_class2 = (_temp = class UiMain extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "pcBg", _descriptor, this);
        }
        ...
        updateSizeFit() {
          ...
          let wi = this.node.getComponent(Widget); // 设置手机端和pc端canvas的显示位置，在pc是横屏的，但是canvas应该是中间的手机位置。所以要左右减 
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "pcBg", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
