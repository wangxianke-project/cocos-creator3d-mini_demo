System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerControll", PlayerControll = (_dec = ccclass('PlayerControll'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_temp = class PlayerControll extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "camera", _descriptor, this);

          _initializerDefineProperty(this, "hp3D", _descriptor2, this);

          _initializerDefineProperty(this, "uiHp", _descriptor3, this);
